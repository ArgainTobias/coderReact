  ...
  return (
    <div className="div-detalle">
        ...
        <div className='div-detalle-info'>
            ...
            {desaparecer ? <Link to={"/cart"} className={`confirmar`}>Terminar mi compra</Link> : <ItemCount stock={producto.stock} initial={1} onAdd={onAdd} id={producto.id} title={producto.title}/>}
        </div>
    </div>
    )
}
